...
{prefix=prefix||'Powered bys';return'<div class="rw-ui-poweredby">\
...
return false;return((RW._isFree()&&RW._showRecommendations())||(RW._isPaid()&&_ri.options.showRecommendations));},
_renderFooter=function()
{var html='';if(_showRecommendations()&&_hasRecommendations())
html+=_renderRecommendations();if(!RW._isPaid())
return html.isEmpty()?'':'<div class="rw-ui-poweredby">'+html+'</div>';},_renderSharing=function()
